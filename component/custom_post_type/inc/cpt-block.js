...
( function( blocks, element, editor, components,serverSideRender) {
	...
	registerBlockType( 'bc/cpt-block', {
		...
		edit: function( props ) {
			...
			var c_field_1 = props.attributes.c_field_1;
			var c_field_2 = props.attributes.c_field_2;
			var c_field_3 = props.attributes.c_field_3;
            ...
            for (const [key, value] of Object.entries(cf)) {
                for (const [keyF, valueF] of Object.entries(value.field)) {
                    if(valueF.type == 'checkbox'){
                        ObjCfChk.push({value: wpFeSanitizeTitle(value.namegroup)+'_'+wpFeSanitizeTitle(valueF.namefield), label: valueF.namefield});
                    }
                }
            };
            ...
            return (
                ...
                el( Fragment, {},
                    ...
                    el( InspectorControls, {},
                        ...
                        el( PanelBody, { title: 'Custom filed 1', initialOpen: false },
                            el(SelectControl,{
                                label: 'Custom field',
                                value: c_field_1,
                                options: ObjCf,
                                onChange: ( value ) => {
                                    props.setAttributes( { c_field_1: value } );
                                },
                            })
                        ),
                        ...
                        el( PanelBody, { title: 'Custom filed 2', initialOpen: false },
                            el(SelectControl,{
                                label: 'Custom field',
                                value: c_field_2,
                                options: ObjCf,
                                onChange: ( value ) => {
                                    props.setAttributes( { c_field_2: value } );
                                },
                            })
                        ),
                        ...
                        el( PanelBody, { title: 'Custom filed 3', initialOpen: false },
                            el(SelectControl,{
                                label: 'Custom field',
                                value: c_field_3,
                                options: ObjCf,
                                onChange: ( value ) => {
                                    props.setAttributes( { c_field_3: value } );
                                },
                            })
                        ),
