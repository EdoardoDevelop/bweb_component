...
<div id="bcpo_select_objects">

<table class="form-table">
	<tbody>
		<tr valign="top">
			<th scope="row"><?php _e( 'Ordinamento Post Types', 'bcpo' ) ?></th>
			<td>
			<?php
				...
				foreach ( $post_types  as $post_type ) {
					...
					?>
					<label><input type="checkbox" name="objects[]" value="<?php echo $post_type->name; ?>" <?php if ( isset( $bcpo_objects ) && is_array( $bcpo_objects ) ) { if ( in_array( $post_type->name, $bcpo_objects ) ) { echo 'checked="checked"'; } } ?>>&nbsp;<?php echo $post_type->label; ?></label><br>
					<?php
				}
			?>
			</td>
...
<div id="bcpo_select_tags">

<table class="form-table">
	<tbody>
		<tr valign="top">
			<th scope="row"><?php _e( 'Ordinamento Taxonomies', 'bcpo' ) ?></th>
			<td>
			<?php
				...
				foreach( $taxonomies as $taxonomy ) {
					...
					?>
					<label><input type="checkbox" name="tags[]" value="<?php echo $taxonomy->name; ?>" <?php if ( isset( $bcpo_tags ) && is_array( $bcpo_tags ) ) { if ( in_array( $taxonomy->name, $bcpo_tags ) ) { echo 'checked="checked"'; } } ?>>&nbsp;<?php echo $taxonomy->label ?></label><br>
					<?php
				}
			?>
			</td>
